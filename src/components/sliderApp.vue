<template>
    ...
    <div class="controls">
        <button class="button prev" @click="prevSlide" :class="{ disabled: currentSlide <= 0 }">Назад</button>
        <button class="button next" @click="nextSlide" :class="{ disabled: currentSlide > 1 }">Вперёд</button>
      </div>
  </template>
